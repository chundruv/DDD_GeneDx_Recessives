...
def read_sample_lists(args):
    ...
    unrel_parents=pd.concat([pd.merge(unrel_parents[0], pedigree['dad_id'], left_on=0, right_on='dad_id'), pd.merge(unrel_parents[0], pedigree['mum_id'], left_on=0, right_on='mum_id')])
